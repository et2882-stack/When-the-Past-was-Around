...
Files
- `index.html` — loads p5.js (CDN) and `sketch.js`.
- `sketch.js` — minimal p5.js sketch (setup + draw).
- `style.css` — simple styles to center the canvas and style the page.

Next steps (suggestions)
- Install the Live Server extension in VS Code for instant reload while editing.
- Replace the sketch in `sketch.js` with your own p5 code.
